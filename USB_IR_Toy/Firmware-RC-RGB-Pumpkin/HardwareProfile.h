...
#define IRRX_ONRB4 //force RB4 interrupt instead of INT2 

//select the correct interrupt pin depending on hardware and settings
#if defined (IRRX_ONRB4)// irRX B4 (25)
...
//insert jump instructions for bootloader
#define PROGRAMMABLE_WITH_USB_HID_BOOTLOADER
//enter bootloader from application
#if defined(PROGRAMMABLE_WITH_USB_HID_BOOTLOADER)
    #define EnterBootloader() _asm goto 0x400 _endasm
#endif  
