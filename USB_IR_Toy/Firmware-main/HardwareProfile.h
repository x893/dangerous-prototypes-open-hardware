...
#define T2_RXsampleperiod()     PR2 = 14; T2CON = PRE_x4 + POST_x2 //100000.1Hz Note that PR2 needs to one less than calulated value
...
#define DisableEachInterrupt() do { PIE1 = 0; IRFREQ_CAPIE = 0; T0_IE = 0; IRRXIE= 0; IRRAWINTIE = 0; } while (0)
