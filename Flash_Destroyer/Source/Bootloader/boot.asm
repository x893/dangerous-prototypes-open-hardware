;;
;;	Diolan BootLoader for Flash Destroyer v1
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;  BootLoader.                                                             ;;
...
main
	...
	setf	JP_BOOTLOADER_TRIS		;TRIS input
	nop
	nop
...
bootloader
#ifdef USE_LED
	;enable '8' (or B) on display
	;common cathode: RB4 (B76532, C7)
	movlw	0b00010000 	;CC4 ON
	movwf	LATB
	movlw 	0b00000011 	;ALL CC to output
	movwf	TRISB
	bcf		LATB, 7		;CC7 OFF too
	bcf		TRISB, 7	;CC7 output too
	;ANODE: RA0-5, RC0-1
	movlw	0b00111111 	;all segments on
	movwf	LATA
	movlw 	0 	;ALL CC to output
	movwf	TRISA
	bsf		LATC, 0		;C0-C1
	bsf		LATC, 1		;C0-C1
	bcf		TRISC, 0	;C0 output too
	bcf		TRISC, 1	;C1 output too
#endif
