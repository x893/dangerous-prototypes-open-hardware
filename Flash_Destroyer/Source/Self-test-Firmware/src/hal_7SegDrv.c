...
static const char SEVENSEGMENTARRAY[][2]=
	{ // A_B, C D E F G
			...
			{0,0x14},	// 19 r
			{1,0x11},	// 20 t
			{3,0x3F}	//21, 8 with dp (test char) 0b00100000;
	};
...
switch(DispMode)
	...
	case DISP_MODE_ERASE:
		...
		break;
	case DISP_MODE_TEST:
		SeveSegmentArray[6]=SEVENSEG_TEST;
		SeveSegmentArray[5]=SEVENSEG_TEST;
		SeveSegmentArray[4]=SEVENSEG_TEST;
		SeveSegmentArray[3]=SEVENSEG_TEST;
		SeveSegmentArray[2]=SEVENSEG_TEST;
		SeveSegmentArray[1]=SEVENSEG_TEST;
		SeveSegmentArray[0]=SEVENSEG_TEST;
		break;
	}
}
