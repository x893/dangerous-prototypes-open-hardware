...
#define SEARCH_PARSER_BUFFER 1400 //432 byte buffer for each of MAX_TREND_TERMS x tweet search results
...
static ROM BYTE TrendURL[] = "/trends/current.json"; //trending topics JSON datafeed URL
static ROM BYTE SearchURL[] = "/search.json?rpp=2&q="; //tweet search JSON datafeed URL
