...
void HD44780_RSData(void); //sets RS pin for text entry
void HD44780_FastText(unsigned char dat); //fast entry of text for smoother scrolling
void LCD_ExitCGRAM(void);
