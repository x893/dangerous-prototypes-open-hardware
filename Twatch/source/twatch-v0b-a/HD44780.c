...
#define LCD_SETUP_DELAY 10 //setup delay for LCD data default is 10(us)
#define LCD_HOLD_DELAY 24 //LCD clock hold time default is 24(us)
...
//lookup table for reversing bit order, speeds display, smoothes scrolling
const rom unsigned char HD44780_lookup[] = {
	0, 16, 8, 24, 4, 20, 12, 28, 2, 
	18, 10, 26, 6, 22, 14, 30, 1, 17, 
	9, 25, 5, 21, 13, 29, 3, 19, 11, 27, 
	7, 23, 15, 31, 
};

void HD44780_RSData(void){
	TRISD|=0b10; //LCD_RS_TRIS=1; //set register select flag for text
}
