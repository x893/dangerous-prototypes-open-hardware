...
namespace ds30Loader
{
	...
	public class clsHex24H : clsHex
	{
		...
		// Constructor()
		//---------------------------------------------------------------------
		public clsHex24H( string pstrFilename ) : base ( pstrFilename )
		{
			// Size buffer arrays
		...
		{
			return Convert.ToInt32(pbWriteProgram) * (iProgPagesUsed * pobjDevice.pageSizeR * pobjDevice.rowsizeW * 3) + Convert.ToInt32(pbWriteConfigs ) * iConfigWordsUsed * 2;
		}// BytesToWrite()
