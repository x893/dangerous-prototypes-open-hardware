...
#define TXSTART_INIT   	0x1A00	// start TX buffer at 0
...
xSemaphoreHandle enc28j60Init(void);
...
//Initialises the DMA for ENC
void enc28j60DMAInit(void);

//Starts receive of packet from ENC via DMA, and
//returns number of packets waiting.
//If zero is returned, no packet was waiting, and no DMA was started
unsigned int enc28j60BeginPacketReceiveDMA(void);

//Starts sending of packet of packetLength size via DMA
