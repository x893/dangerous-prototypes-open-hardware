...
#define CDC_DATA_IN_EP_SIZE     65 // MGr: If CDC_DATA_IN_EP_SIZE is the same size as my USB_IN_ENDPOINT_PACKET_SIZE, transfer is substantially slower.  (1 second on my laptop, 4 seconds on a desktop with UHCI host chips.)

#define USB_IN_ENDPOINT_PACKET_SIZE 64 // MGr
